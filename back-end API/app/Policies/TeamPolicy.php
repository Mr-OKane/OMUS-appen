...
class TeamPolicy
{
    ...
    {
        return $user->role->permissions->contains(Permission::firstWhere('name','=','team.view'))
            ? Response::allow()
            : Response::deny('you are not the chosen one');
    }
    ...
    {
        return $user->role->permissions->contains(Permission::firstWhere('name','=','team.create'))
            ? Response::allow()
            : Response::deny('you are not the chosen one');
    }
    ...
    {
        return $user->role->permissions->contains(Permission::firstWhere('name','=','team.update'))
            ? Response::allow()
            : Response::deny('you are not the chosen one');
    }
    ...
    {
        return $user->role->permissions->contains(Permission::firstWhere('name','=','team.restore'))
            ? Response::allow()
            : Response::deny('you are not the chosen one');
    }
    ...
    {
        return $user->role->permissions->contains(Permission::firstWhere('name','=','team.delete.force'))
            ? Response::allow()
            : Response::deny('you are not the chosen one');
    }
}
